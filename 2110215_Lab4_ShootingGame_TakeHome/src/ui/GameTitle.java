	...
	public GameTitle() {
		...
		newGame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				ConfigurableOption.objectCreationMinDelay = (int) scmind.getValue();
				ConfigurableOption.objectCreationMaxDelay = (int) scmaxd.getValue();
				ConfigurableOption.objectMinDuration = (int) somind.getValue();
				ConfigurableOption.objectMaxDuration = (int) somaxd.getValue();
				ConfigurableOption.timelimit = (int) stimelimit.getValue();
				GameManager.newGame();
			}
		});
