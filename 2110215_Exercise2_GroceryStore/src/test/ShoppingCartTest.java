...
public class ShoppingCartTest {
	...
	public void testIsDiscounted() {
		...
		//If the number of UnitItem or WeightItem isn't equal the prerequisite, customer won't get a discount.
		assertEquals(false, cart.isDiscounted());
		
		//If the number of UnitItem or WeightItem is equal the prerequisite, customer will get a discount.
		cart.addItem(w_item2);
